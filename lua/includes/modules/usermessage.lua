-- We need to load net earlier :/
-- Those net files don't autoload
-- Becase we have a ! in the beginning of the file name.
-- Which disables it from being autoloaded
if SERVER then
    include("jlib/!sv_net.lua")
    AddCSLuaFile("jlib/!cl_net.lua")
end

if CLIENT then
    include("jlib/!cl_net.lua")
end
